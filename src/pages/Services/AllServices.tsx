...
const AllServices = () => (
  <section className="py-24 bg-gradient-to-b from-gray-50 via-teal-100 to-teal-300 relative overflow-hidden min-h-screen">
      ...
      {allServices.map((service, index) => (
        ...
        >
          ...
          <div className={`md:space-y-6 space-y-2 ${service.reverse ? "md:col-start-2" : ""}`}>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 leading-tight mb-2">
              {service.title}
            </h2>
